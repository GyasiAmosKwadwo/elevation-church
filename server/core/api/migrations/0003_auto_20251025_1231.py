...
def drop_legacy_api_tables(apps, schema_editor):
    tables = [
        "api_announcement",
        "api_event",
        "api_live_stream",
        ...
        "api_series",
        "api_sermon",
        "api_devotion_reflection",
        "api_series_thoughts",
        "api_series_available_sermons",
    ]
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(drop_legacy_api_tables, migrations.RunPython.noop),
